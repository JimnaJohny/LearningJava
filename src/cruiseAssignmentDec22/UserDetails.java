...
public class UserDetails {
	...
	public void setPhoneNumber(String phoneNumber, Scanner sc) {
	...
	public void setEmailId(String emailId,Scanner sc) {
	...
	public void logIn(String logInUserName, String logInPassword,Scanner sc) {
	...
	public boolean isPassWordValidated(String passwordToCheck, Scanner sc) {
		for (int i = 0; i < 3; i++) {
